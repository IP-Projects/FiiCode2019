...
@Component({
  ...
  styleUrls: ["./collection-loader.component.scss"]
})
export class CollectionLoaderComponent implements OnInit {
  ...
  //   <div class="row">
  //     <div class="column">
  //          <iframe src="https://www.youtube.com/embed/fGk7rc05pEc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  //     </div>
  ...
  //          <iframe
  //          src="https://www.youtube.com/embed/fGk7rc05pEc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  //       </div>
